...
class _MotorControlPageState extends ConsumerState<MotorControlPage> {
  ...
  final Map<String, MotorControlConfig> _gamepadConfigs = {
    ...
    'dPadVertical': const MotorControlConfig(
      motorLabel: 'l',
      initialValue: 30.0,
      stepValue: 10.0, // Positive for Up
    ),
  ...
  void _resetGamepadToDefaults(MqttService mqttService) {
    setState(() {
      ...
      _motorAngles['b'] = 90.0; _motorAngles['d'] = 90.0; _motorAngles['f'] = 90.0;
      ...
      _arm2SliderValC = 90.0; _arm2SliderValD = 90.0;
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    // MODIFIED: Uses central state
                    onPressed: () {
                      setState(() => _motorAngles[clawMotorLabel] = 0.0);
          ...
          children: [
            Row(
              children: [
                ...
                TextButton(
                  onPressed: () {
                    setState(() => _motorAngles[clawMotorLabel] = 0);
                    mqttService.publish('servo/arm2/$clawMotorLabel', jsonEncode({"angle": 0}));
                  },
                  child: const Text("Close"),
                ),
