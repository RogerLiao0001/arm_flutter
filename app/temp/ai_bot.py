...
class AIBot:
    ...
    async def run(self):
        ...
        def on_data_received(packet):
            # LiveKit 的 data_received 事件只傳遞一個 DataReceivedEvent 物件
            asyncio.create_task(self.on_data_received(packet.data_packet, packet.participant))
