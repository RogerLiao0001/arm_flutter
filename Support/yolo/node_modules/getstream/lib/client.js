...
var _data_privacy = _interopRequireDefault(require("./data_privacy"));
...
var StreamClient = exports.StreamClient = /*#__PURE__*/function () {
  ...
  function StreamClient(apiKey, apiSecretOrToken, appId) {
    ...
    // eslint-disable-line no-use-before-define
    (0, _defineProperty2.default)(this, "deleteActivities", void 0);
    // eslint-disable-line no-use-before-define
    (0, _defineProperty2.default)(this, "deleteReactions", void 0);
    // eslint-disable-line no-use-before-define
    (0, _defineProperty2.default)(this, "exportUserActivitiesAndReactionIDs", void 0);
    ...
    if (_batch_operations.default && !!_redirect_url.default && _data_privacy.default) {
      ...
      this.deleteActivities = _data_privacy.default.deleteActivities;
      this.deleteReactions = _data_privacy.default.deleteReactions;
      this.exportUserActivitiesAndReactionIDs = _data_privacy.default.exportUserActivitiesAndReactionIDs;
    }
  }
