...
import { ExportIDsResponse, ActivityToDelete } from './data_privacy';
...
export declare class StreamClient<StreamFeedGenerics extends DefaultGenerics = DefaultGenerics> {
    ...
    deleteActivities?: (this: StreamClient, activities: ActivityToDelete[]) => Promise<APIResponse>;
    deleteReactions?: (this: StreamClient, ids: string[]) => Promise<APIResponse>;
    exportUserActivitiesAndReactionIDs?: (this: StreamClient, userId: string) => Promise<ExportIDsResponse>;
    /**
     * Initialize a client
