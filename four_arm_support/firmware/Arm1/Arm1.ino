...
// *** MODIFIED FOR ARM 1 ***
const char* subscribe_topic = "servo/arm1/#";
...
void reconnect() {
  while (!client.connected()) {
    ...
    // *** MODIFIED FOR ARM 1 ***
    String clientId = "ESP8266-Forwarder-Arm1-";
...
void setup() {
  ...
  Serial.begin(115200);
  // *** MODIFIED FOR ARM 1 ***
  Serial.println("\n\nESP8266 Pure Forwarder v11.0 (Arm 1) Booting...");
  delay(1000);
  ...
  if (!wifiManager.autoConnect("ESP8266_Arm1_Setup")) {
