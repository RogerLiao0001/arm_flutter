...
// *** MODIFIED FOR ARM 4 ***
const char* subscribe_topic = "servo/arm4/#";
...
void reconnect() {
  while (!client.connected()) {
    ...
    // *** MODIFIED FOR ARM 4 ***
    String clientId = "ESP8266-Forwarder-Arm4-";
...
void setup() {
  ...
  Serial.begin(115200);
  // *** MODIFIED FOR ARM 4 ***
  Serial.println("\n\nESP8266 Pure Forwarder v11.0 (Arm 4) Booting...");
  delay(1000);
  ...
  if (!wifiManager.autoConnect("ESP8266_Arm4_Setup")) {
