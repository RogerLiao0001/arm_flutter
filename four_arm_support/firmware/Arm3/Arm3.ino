...
// *** MODIFIED FOR ARM 3 ***
const char* subscribe_topic = "servo/arm3/#";
...
void reconnect() {
  while (!client.connected()) {
    ...
    // *** MODIFIED FOR ARM 3 ***
    String clientId = "ESP8266-Forwarder-Arm3-";
...
void setup() {
  ...
  Serial.begin(115200);
  // *** MODIFIED FOR ARM 3 ***
  Serial.println("\n\nESP8266 Pure Forwarder v11.0 (Arm 3) Booting...");
  delay(1000);
  ...
  if (!wifiManager.autoConnect("ESP8266_Arm3_Setup")) {
